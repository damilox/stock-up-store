...
export default function RequestCard() {
  const handleRequest = (e: React.MouseEvent) => {
    ...
    // The specific format WhatsApp API prefers
    const phone = "2348102816015";
    const text = "Hello StockUp! I want to order something not on the list.";
    
    // Create the URL using the official API link
